    ...
    <>
      <Content style={{ marginBottom: "2em" }}>
        ...
        <p>
          ...
          to check a pilots fitting meets requirements. Specialist badges are not required for any pilot but are
          there if you wish to upgrade further, specialist badges come with the option to use the rattlesnake.
        </p>
